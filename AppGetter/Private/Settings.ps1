function Get-AppGetterDefaultBaseOutputPath {
    # Default base is a folder named after the app (AppGetter), matching Wingetter.
    ...
    return (Join-Path $homeDir $docsFolder)
}
...
function Get-AppGetterSettings {
    ...
    # Migrate the old portable default so existing installs land under Documents\AppGetter\{App}.
